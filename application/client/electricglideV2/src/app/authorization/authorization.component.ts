...
export class AuthorizationComponent implements OnInit {
  ...
  getQuoteOMaticPages() {
    this.authService.GpGetAllScreen().subscribe((screendata) => {
      ...
      console.log("stored pages",this.storedpages);
      
      screendata.forEach((element: { resources: never[]; }) => {
        this.camundapage = element.resources;
        console.log("this.camundapage",this.camundapage);
      ...
      console.log(" this.storedpages", this.storedpages);
  ...
  SetRoles() {
    ...
    existingpages.forEach(element => {
      ...
      console.log("savepage",savedpage);
